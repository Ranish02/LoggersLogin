    ...
    if (!filter_var($email, FILTER_VALIDATE_EMAIL)) {
        ...
        if (mysqli_num_rows($query) == 0) {
            ...
            $message = "
				...
				<body>
				<h2>Is your account locked due to multiple failed login attempts?</h2>
				<p>Your Account:</p>
				<p>Email: " . $email . "</p>
				<p>Please click the link below to reset your account.</p>
				<h4><a href='http://localhost/loggerslogin/accountresetter.php?uid=$uid&code=$code'>Reset Account</h4>
                <p>And if forgotten the password.Reset the password using the link.</p>
...
<body>
    <div class="container">
        <div id="login_form" class="well">
            <h2>
                <center><span class="glyphicon glyphicon-lock"></span>Account Locked?</center>
                <span class="h4">Enter your email to send a reset account link</span>
            </h2>
            <div class="form-element">
                <form action="resetaccount.php" method="post">
                    ...
                    <br>
                    <div class="flex">
                        <div class="already">Want to login?<a href="index.php">Login</a></div>
                        <div class="already">Create new Account?<a href="signup.php">Sign up</a></div>
