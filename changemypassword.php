...
?>
            ...
            <div id="signup_form" class="well">
                ...
                <div class="form-element">
                    <form method="POST" action="passwordchanger.php">
                        ...
                        <input onkeyup="trigger()" type="password" name="current_password" id="current_password" class="form-control" required>
                        <div class="flex">
                            <span id="click2">
                                <i class="bi bi-eye-slash" id="clicks2"></i>
                            </span>
                        </div>
    ...
    <script src="Javascript/passwordchange.js"></script>
